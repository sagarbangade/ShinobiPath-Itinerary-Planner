...
const Login = () => {
  ...
  return (
    <div ref={containerRef} className="bg-gray-950 min-h-screen flex flex-col text-white relative overflow-hidden">
      {/* Particles */}
        ...
        <div className="bg-black bg-opacity-70 p-8 rounded-3xl shadow-2xl w-full max-w-md backdrop-blur-md"> {/* Added backdrop-blur-md */}
          ...
          >
            <div className="flex items-center justify-center">
              <img src="https://cdn-icons-png.flaticon.com/256/2875/2875331.png" alt="Google Logo" className="w-6 h-6 mr-2" />
